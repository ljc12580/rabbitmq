...
package com.eking.micro.common.port.adapter.notification;

import com.eking.micro.common.domain.model.DomainEvent;
import com.eking.micro.common.event.EventStore;
import com.eking.micro.common.event.StoredEvent;
import com.eking.micro.common.notification.*;
import com.eking.micro.common.port.adapter.messaging.rabbitmq.Exchange;
import com.eking.micro.common.port.adapter.messaging.rabbitmq.MessageProducer;
import com.eking.micro.common.port.adapter.messaging.rabbitmq.ConnectionSettings;
...
public class RabbitMQNotificationPublisher implements NotificationPublisher {
    ...
    private MessageProducer messageProducer() {
        ...
        // create a message event used to forward events
